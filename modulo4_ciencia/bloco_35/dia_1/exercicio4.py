...
#  usando o módulo socketserver
#  (https://docs.python.org/3/library/socketserver.html) que já vem embutido
...
#  localhost 8085 , onde telnet é a aplicação que iremos utilizar, localhost é
#  o local onde o servidor está (no caso, o seu próprio PC) e 8085 é a porta
...
#  requisições
#  * os dados na requisição vêm em bytes -- não strings! bytes podem
#  ser decodificados em string com a codificação correta
