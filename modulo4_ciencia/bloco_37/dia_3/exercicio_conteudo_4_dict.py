...
# Importante! Apenas objetos imutáveis podem ser utilizados como chave. Ou
# seja, apenas aqueles objetos que depois de instanciados não podem ser
# alterados. Isso varia de linguagem para linguagem. Em Python, os objetos
# imutáveis são:
