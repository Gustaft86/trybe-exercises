from exercicio_conteudo_1_classe_node import Node
...
class LinkedList:
    ...
    para que o novo valor, que estamos inserindo no início da lista, seja
    preenchido na variável head_value , se tornando a "cabeça" da lista."""
