# Relatórios de Vendas . Nosso programa tem que conter toda uma lógica para ler
# dados e criar o relatório e, ao final, vamos gerar um arquivo imprimível com
# tais dados. Um JSON, por exemplo. Como estamos trabalhando com orientação
# a objetos, vamos pensar! Qual entidade eu preciso criar para resolver meu
# problema?
