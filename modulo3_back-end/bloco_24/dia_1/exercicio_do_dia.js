...
// Exercício 2 : Altere budget para 1 no filme Godzilla . (Campo não existe, será criado!!!)
...
// Exercício 10 : Utilizando o operador $currentDate , crie um campo chamado lastUpdated com o tipo timestamp 
// no filme Home Alone.
db.movies.updateOne({ title: "Home Alone" }, { $currentDate: { "lastUpdated": { $type: "timestamp" } } });

// Exercício 11 : Utilizando uma única operação, crie um campo chamado sequels e atribua a ele o valor 0 em todos 
// os documentos.
db.movies.updateMany({}, { "sequels": 0 });
