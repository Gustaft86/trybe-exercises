const searchEmployee = require('./exercicio9.js');

describe('Testa a função searchEmployee', () => {
  it('a função searchEmployee é definida', () => {
    expect(searchEmployee).toBeDefined();
  });
  it('a função searchEmployee lança erro caso não exista funcionario com o id passado', () => {
    expect(() => { searchEmployee("4678-2", "5") }).toThrow();
    expect(() => { searchEmployee(4, "5") }).toThrowError(new Error("ID não identificada"));
  });
